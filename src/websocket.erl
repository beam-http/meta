...
%TODO: Fix this to the header standard we decide on
...
%TODO: Fix these headers to standardized format or rework this to be more flex
...
%TODO: Add the rest of the opcodes (pong and etc)
